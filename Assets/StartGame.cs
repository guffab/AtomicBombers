...
public class StartGame : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        //text (large)
        PlaceLargeText(4, 14, LevelManager.Level.WorldName);
        PlaceLargeText(4, 11, LevelManager.Level.Name);

        //text (small)
        grid = new Grid(new Vector2Int(16, 16));
        PlaceText(25, 10, $"ROUND {GameRound}".PadLeft(10));
        PlaceText(6, 26, "WORLD");
        PlaceText(6, 20, "LEVEL");

        void PlaceWinners(System.Collections.Generic.List<int> players)
        {
